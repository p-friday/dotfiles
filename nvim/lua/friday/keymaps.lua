...
-- keep cursor in the middle for scrolling
...
-- cursor stays in place when folding lines
vim.keymap.set("n", "J", "mzJ`z")

-- replace selection but preserve current copy
